 ...
 * @author huajie <banhuajie@163.com>
 */
function get_specialists($date_typt = 'array'){
	
	$model_id = get_document_field('specialist','name','id');

	$Data = M('Document');
	$map['model_id'] = $model_id;
	$s_list = $Data->field('id,title')->where($map)->order('level desc')->select();
 ...
 * @author huajie <banhuajie@163.com>
 */
function get_armarium($date_typt = 'array'){
	
	$model_id = get_document_field('armarium','name','id');
