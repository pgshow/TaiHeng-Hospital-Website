...
<div class="exzj texzj"><div class="exspan-l"><?php echo ($Category_info["eng_title1"]); ?></div> <div class="exspan-2" style="
    width: 700px;
"><?php echo ($Category_info["eng_title2"]); ?></div> </div>
...
<div class="zjcon">
  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="zjcon_1
  <?php if(($mod) == "0"): ?>fl<?php endif; ?>
  <?php if(($mod) == "1"): ?>fr<?php endif; ?>
  ">
      <div class="zjcon_left fl">
        <a href="<?php echo U('/specialist');?>/a/<?php echo ($vo["id"]); ?>.html" target="_blank"><img src="<?php echo (get_cover($vo["photo"],'path')); ?>" width="245" height="165"></a><br>
        <span class="zj_zt"></span> </div>
      <div class="zjcon_right fl">
        
        <h2 class="zjjs_1"><?php echo ($vo["title"]); ?></h2>
        <span class="zjjs_2"><br>
        <?php echo ($vo["intro"]); ?></span>
        <div class="zjcon_zx"><a href="<?php echo U('/specialist');?>/a/<?php echo ($vo["id"]); ?>.html" target="_blank" class="fl">点击详细</a><a href="http://lvt.zoosnet.net/LR/Chatpre.aspx?id=LVT74007147&lng=cn" target="_blank" class="ljyy fl">立即预约</a></div>
      </div>
    </div>
    
    <div class="hig_30"></div><?php endforeach; endif; else: echo "" ;endif; ?>

    <map name="Map" id="Map">
      <area shape="rect" coords="75,2,180,40" href="/">
      <area shape="rect" coords="325,1,412,39" href="/">
      <area shape="rect" coords="567,1,630,39" href="/qyjs/" target="_blank">
      <area shape="rect" coords="807,2,866,38" href="/zixun/" target="_blank">
    </map>
   <hr data-am-widget="divider" style="" class="am-divider am-divider-dotted am-no-layout">
