...
<div class="news-quanju">
	<div class="news-center">
            ...
            <div class="wzlb_1"><img src="/Public/Home/i/news/xinwen.png" class="wzimg fl"><p><?php echo ($Category_info["title"]); ?></p></div>
            <!--中间部分开始-->
          <div class="so_c">
       	    <p class="so_bt"><?php echo ($Article_info["title"]); ?></p>
                <div class="so_bt_1"><div>文章来源：www.th023.com</div>  <div>日期：<?php echo (date('Y-m-d',$Article_info["create_time"])); ?></div> <div>作者：重庆泰恒眼科医院</div>                          </div>
				<div class="tqa">
				<div class="tqa1"><span style="float:left;">分享文章：</span><div class="bdsharebuttonbox"><a href="#" class="bds_more" data-cmd="more"></a><a href="#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a><a href="#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a><a href="#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a><a href="#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a><a href="#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a></div>
<script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"0","bdSize":"16"},"share":{}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script></div>
				<div class="tqa1">
				<div class="suoxiao"><img src="/Public/Home/i/page/6.png"></div><div class="fangda"><img src="/Public/Home/i/page/7.png"></div><div class="wzdaa">文字大小：</div>
				</div></div>
                <div class="hig_30"></div>
                <div class="so_dd"><p class="dd">导读： <span class="dd_jj"><?php echo (intro($Article_info["content"],0,120)); ?></span></p></div>
            <div class="so_nr">
                <?php echo ($Article_info["content"]); ?>
            </div>
                <div class="dqdz">本文地址：<a href="http://www.th023.com<?php echo U('/illness');?>/a/<?php echo ($Article_info["id"]); ?>.html">http://www.th023.com<?php echo U('/illness');?>/a/<?php echo ($Article_info["id"]); ?>.html</a></div>
		        <!--文章内容下的按钮开始-->
		        <ul class="page-gu">
    ...
    <li> <a href="http://lvt.zoosnet.net/LR/Chatpre.aspx?id=LVT74007147&lng=cn" target="_blank"><img src="/Public/Home/i/4.jpg"></a></li>
				...
				<!--文章内容下的按钮结束-->
                <div class="fy">
				    <?php if(($front != '')): ?><a href="<?php echo U('/illness');?>/a/<?php echo ($front); ?>.html" class="fr">上一篇</a><?php endif; ?>
					<?php if(($after != '')): ?><a href="<?php echo U('/illness');?>/a/<?php echo ($after); ?>.html" class="fl">下一篇</a><?php endif; ?>
                </div>
          </div>          
          <!--中间部分结束-->
        </div>
			<div class="quan-title" style="margin-top:20px;"><h1>知名专家<span>SPECIALLISTS</span></h1></div>
			<!--轮播开始-->
            <div data-am-widget="slider" class="am-slider am-slider-a1 am-slider-page" data-am-slider='{"directionNav":false}' >
  <ul class="am-slides">
      <li>
        	<div class="page30">
              <ul>
                <?php if(is_array($famous_specialist)): $i = 0; $__LIST__ = array_slice($famous_specialist,0,3,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$fsvo): $mod = ($i % 2 );++$i;?><li> <a href="<?php echo U('/specialist');?>/a/<?php echo ($fsvo["id"]); ?>.html" target="_blank"><img src="<?php echo (get_cover($fsvo["photo"],'path')); ?>" width="185" height="122"></a>
                    <div class="pag-title">
                    <h1><a href="<?php echo U('/specialist');?>/a/<?php echo ($fsvo["id"]); ?>.html" target="_blank"><?php echo ($fsvo["title"]); ?></a></h1>
                    <h2><?php echo ($fsvo["situation"]); ?></h2>
                    <a href="<?php echo U('/specialist');?>/a/<?php echo ($fsvo["id"]); ?>.html" target="_blank">点击详细</a>
                    <a href="http://lvt.zoosnet.net/LR/Chatpre.aspx?id=LVT74007147&lng=cn" target="_blank">立即预约</a>
                  </div>
      ...
      <li>
        	<div class="page30">
              <ul>
                <?php if(is_array($famous_specialist)): $i = 0; $__LIST__ = array_slice($famous_specialist,3,3,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$fsvo): $mod = ($i % 2 );++$i;?><li> <a href="<?php echo U('/specialist');?>/a/<?php echo ($fsvo["id"]); ?>.html" target="_blank"><img src="<?php echo (get_cover($fsvo["photo"],'path')); ?>" width="185" height="122"></a>
                    <div class="pag-title">
                    <h1><a href="<?php echo U('/specialist');?>/a/<?php echo ($fsvo["id"]); ?>.html" target="_blank"><?php echo ($fsvo["title"]); ?></a></h1>
                    <h2><?php echo ($fsvo["situation"]); ?></h2>
                    <a href="<?php echo U('/specialist');?>/a/<?php echo ($fsvo["id"]); ?>.html" target="_blank">点击详细</a>
			...
			<!--最新文章开始-->
			<div class="zu-page">
			<div class="bt"><h2>最新文章<span>NEW ATICLES</span></h2></div>
			<div data-am-widget="list_news" class="am-list-news am-list-news-default am-no-layout">
  <div class="am-list-news-bd">
  <ul class="am-list">
    <?php if(is_array($bottom_latest)): $i = 0; $__LIST__ = array_slice($bottom_latest,0,6,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$blvo): $mod = ($i % 2 );++$i;?><li class="am-g am-list-item-dated">
          <a href="/<?php echo ($bottom_latest_name); ?>/a/<?php echo ($blvo["id"]); ?>.html" target="_blank" class="am-list-item-hd "><?php echo ($blvo["title"]); ?></a>
          <span class="am-list-date"><a href="/<?php echo ($bottom_latest_name); ?>/a/<?php echo ($blvo["id"]); ?>.html" target="_blank">[<?php echo (date('m-d',$blvo["create_time"])); ?>]</a></span>
    </li><?php endforeach; endif; else: echo "" ;endif; ?>
  </ul>
  </div>
  ...
  <div class="am-list-news-bd">
  <ul class="am-list">
    <?php if(is_array($bottom_latest)): $i = 0; $__LIST__ = array_slice($bottom_latest,6,6,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$blvo): $mod = ($i % 2 );++$i;?><li class="am-g am-list-item-dated">
          <a href="/<?php echo ($bottom_latest_name); ?>/a/<?php echo ($blvo["id"]); ?>.html" target="_blank" class="am-list-item-hd "><?php echo ($blvo["title"]); ?></a>
          <span class="am-list-date"><a href="/<?php echo ($bottom_latest_name); ?>/a/<?php echo ($blvo["id"]); ?>.html" target="_blank">[<?php echo (date('m-d',$blvo["create_time"])); ?>]</a></span>
    </li><?php endforeach; endif; else: echo "" ;endif; ?>
  </ul>
...
<div class="news-center-right">
	<div data-am-widget="slider" class="am-slider am-slider-a1" data-am-slider='{"directionNav":false}' >
	  <ul class="am-slides">
		  <li>
			  <a href="<?php echo ($Office_info["o_side1_url"]); ?>" target="_blank"><img src="<?php echo (get_cover($Office_info["o_side1"],'path')); ?>" width="320" height="290"></a>
		  </li>
		  <li>
			  <a href="<?php echo ($Office_info["o_side2_url"]); ?>" target="_blank"><img src="<?php echo (get_cover($Office_info["o_side2"],'path')); ?>" width="320" height="290"></a>
		  </li>
		  <li>
			  <a href="<?php echo ($Office_info["o_side3_url"]); ?>" target="_blank"><img src="<?php echo (get_cover($Office_info["o_side3"],'path')); ?>" width="320" height="290"></a>
		  </li>
	  </ul>
	</div>
...
<li class="sopli7 sopli"><img src="/Public/Home/i/news/r7.png"><span><a href="">CX2000玻璃体切割仪</a></span></li>
  ...
  margin-top: 20px;
"><h1>专家答疑<span>ASK-THE-EXPERTS</span></h1></div>
...
<ul class="am-list">
    <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-left" style="border-top: none;padding: 10px 0 10px 0;">
      <div class="am-u-sm-4 am-list-thumb">
        <a href="<?php echo U('/news');?>/a/<?php echo ($experts_answer[0]['id']); ?>.html" target="_blank" class="">
            <?php if(($experts_answer[0]['cover_id'] != 0)): ?><img src="<?php echo (get_cover($experts_answer[0]['cover_id'],'path')); ?>" width="120" height="135">
            <?php else: ?>
                <img src="/Public/Home/i/news/anlitu.png" width="120" height="135"><?php endif; ?>
        </a>
      </div>
      <div class=" am-u-sm-8 am-list-main">
          <h3 class="am-list-item-hd"><a href="<?php echo U('/news');?>/a/<?php echo ($experts_answer[0]['id']); ?>.html" target="_blank" class=""><?php echo ($experts_answer[0]['title']); ?></a></h3>

          <div class="am-list-item-text"><?php echo (intro($experts_answer[0]['description'],0,45)); ?><a href="<?php echo U('/news');?>/a/<?php echo ($experts_answer[0]['id']); ?>.html" target="_blank">[详细]</a></div>
    ...
    <div class="am-list-news-bd">
<ul class="am-list">
  <?php if(is_array($experts_answer)): $i = 0; $__LIST__ = array_slice($experts_answer,1,3,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$eavo): $mod = ($i % 2 );++$i;?><li class="am-g am-list-item-dated am-list1">
          <a href="<?php echo U('/news');?>/a/<?php echo ($eavo["id"]); ?>.html" target="_blank" class="am-list-item-hd "><?php echo ($eavo["title"]); ?></a>
          <span class="am-list-date"><a href="<?php echo U('/news');?>/a/<?php echo ($eavo["id"]); ?>.html" target="_blank">[详细]</a></span>
    </li><?php endforeach; endif; else: echo "" ;endif; ?>
  </ul>
  </div>
