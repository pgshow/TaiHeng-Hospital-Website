...
<div class="news-quanju">
	<div class="news-center">
		...
		<!--doctor开始-->
		<div class="show_wz">
        	<div class="show_name"><p><?php echo (strtoupper($Article_info["eng_name"])); ?></br><span><?php echo ($Article_info["title"]); ?></span></p></br>
            </div>
            <div class="show_wz_1">
              <div class="show_wz_left fl">
                <p class="show_wz_top"> <img src="/Public/Home/i/doctor/shozj.png"></br>
                    <span class="show_wz_top_1"> <a href="javascript:void(0);">专家简介</a></br>The Doctor Introduction</span> </p>
                <p class="show_wz_top_t"> <a href="http://lvt.zoosnet.net/LR/Chatpre.aspx?id=LVT74007147&lng=cn" target="_blank"><img src="/Public/Home/i/doctor/shozj_1.png"></a></br>
                    <span class="show_wz_top_1"> <a href="http://lvt.zoosnet.net/LR/Chatpre.aspx?id=LVT74007147&lng=cn" target="_blank" >立即预约</a></span> </p>
                <p class="show_wz_top_t"> <a href="http://lvt.zoosnet.net/LR/Chatpre.aspx?id=LVT74007147&lng=cn" target="_blank" ><img src="/Public/Home/i/doctor/shouji.png"></a> </p>
              </div>
              <div class="show_wz_right fr">
                  <li>
	                  <img src="<?php echo (get_cover($Article_info["photo"],'path')); ?>" width="480" height="320" border="0">
				  </li> 
			  </div>
            </div>
          <div class="show_wz_2">
              <?php echo ($Article_info["introduce"]); ?>
		  <div>
	&nbsp;</div>
    ...
    margin-bottom: 0;
">
          	        <?php if(($front != '')): ?><a href="<?php echo U('/specialist');?>/a/<?php echo ($front); ?>.html" class="fr">上一篇</a><?php endif; ?>
					<?php if(($after != '')): ?><a href="<?php echo U('/specialist');?>/a/<?php echo ($after); ?>.html" class="fl">下一篇</a><?php endif; ?>
          </div>
    	</div>
        <!--doctor结束-->		
	<div class="xgmy">
      		<p>相关专家<span>ASSOCIATED WITH THE DOCTOR</span></p>
	   <div class="doctor-img">
		  <img src="/Public/Home/i/doctor/dd.png">
	   </div>
	<div class="and_doctor">
    <ul>
       <li>
		 <a href="<?php echo U('/specialist');?>/a/<?php echo ($unite[0]['id']); ?>.html" target="_blank"><img src="<?php echo (get_cover($unite[0]['photo'],'path')); ?>" border="0" width="135" height="90"  ></a>
		 <a href="<?php echo U('/specialist');?>/a/<?php echo ($unite[0]['id']); ?>.html" target="_blank"><?php echo ($unite["0"]["title"]); ?></a>
       </li>
       <li style="margin: 0 19px 19px;">
         <a href="<?php echo U('/specialist');?>/a/<?php echo ($unite[1]['id']); ?>.html" target="_blank"><img src="<?php echo (get_cover($unite[1]['photo'],'path')); ?>" border="0" width="135" height="90"></a>
         <a href="<?php echo U('/specialist');?>/a/<?php echo ($unite[1]['id']); ?>.html" target="_blank"><?php echo ($unite["1"]["title"]); ?></a>
	   </li>
       <li style="margin-right: 18px;">
		 <a href="<?php echo U('/specialist');?>/a/<?php echo ($unite[2]['id']); ?>.html" target="_blank"><img src="<?php echo (get_cover($unite[2]['photo'],'path')); ?>" border="0" width="135" height="90"></a>
		 <a href="<?php echo U('/specialist');?>/a/<?php echo ($unite[2]['id']); ?>.html" target="_blank"><?php echo ($unite["2"]["title"]); ?></a>
	   </li>
       <li>
         <a href="<?php echo U('/specialist');?>/a/<?php echo ($unite[3]['id']); ?>.html" target="_blank"><img src="<?php echo (get_cover($unite[3]['photo'],'path')); ?>" border="0" width="135" height="90"></a>
         <a href="<?php echo U('/specialist');?>/a/<?php echo ($unite[3]['id']); ?>.html" target="_blank"><?php echo ($unite["3"]["title"]); ?></a>
       </li>
       <li>
         <a href="<?php echo U('/specialist');?>/a/<?php echo ($unite[4]['id']); ?>.html" target="_blank"><img src="<?php echo (get_cover($unite[4]['photo'],'path')); ?>" border="0" width="135" height="90" ></a>
         <a href="<?php echo U('/specialist');?>/a/<?php echo ($unite[4]['id']); ?>.html" target="_blank"><?php echo ($unite["4"]["title"]); ?></a>
       </li>
       <li style="margin: 0 19px 19px;">
         <a href="<?php echo U('/specialist');?>/a/<?php echo ($unite[5]['id']); ?>.html" target="_blank"><img src="<?php echo (get_cover($unite[5]['photo'],'path')); ?>" border="0" width="135" height="90" ></a>
         <a href="<?php echo U('/specialist');?>/a/<?php echo ($unite[5]['id']); ?>.html" target="_blank"><?php echo ($unite["5"]["title"]); ?></a>
       </li>
	   <li style="margin-right: 18px;">
         <a href="<?php echo U('/specialist');?>/a/<?php echo ($unite[6]['id']); ?>.html" target="_blank"><img src="<?php echo (get_cover($unite[6]['photo'],'path')); ?>" border="0" width="135" height="90" ></a>
         <a href="<?php echo U('/specialist');?>/a/<?php echo ($unite[6]['id']); ?>.html" target="_blank"><?php echo ($unite["6"]["title"]); ?></a>
       </li>
	   <li>
         <a href="<?php echo U('/specialist');?>/a/<?php echo ($unite[7]['id']); ?>.html" target="_blank"><img src="<?php echo (get_cover($unite[7]['photo'],'path')); ?>" border="0" width="135" height="90" ></a>
         <a href="<?php echo U('/specialist');?>/a/<?php echo ($unite[7]['id']); ?>.html" target="_blank"><?php echo ($unite["7"]["title"]); ?></a>
       </li>
    </ul>
	</div>
      </div>
