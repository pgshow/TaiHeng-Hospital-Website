...
">
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if (1 == $i) { echo "<div>"; } if (0 == ($i%4)) { echo "<div class=\"video-center-4\">"; } else { echo "<div class=\"video-center-1\">"; } ?>

    <a href="<?php echo U('/video');?>/a/<?php echo ($vo["id"]); ?>.html" target="_blank"><img src="<?php echo (get_cover($vo["cover_id"],'path')); ?>" width="220" height="108"></a>
    <p><a href="<?php echo U('/video');?>/a/<?php echo ($vo["id"]); ?>.html" target="_blank"><?php echo ($vo["title"]); ?></a></p>
  </div>
    
    <?php
 if ($i == count($list)) { echo "</div>"; } else if(0 == ($i%4)) { echo "</div><div>"; } endforeach; endif; else: echo "" ;endif; ?>
