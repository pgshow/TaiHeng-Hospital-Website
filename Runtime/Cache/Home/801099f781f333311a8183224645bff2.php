...
<div class="contentt" style="margin-bottom: 40px;">
<div class="one">
<p style="margin-bottom: -7px;">当前位置：<?php echo C('WEB_SITE_TITLE');?> > <?php echo ($Category_info["title"]); ?></p>
<div class="exzj texzj"><div class="exspan-l"><?php echo ($Category_info["eng_title1"]); ?></div> <div class="exspan-2" style="width: 750px;"><?php echo ($Category_info["eng_title2"]); ?></div></div>
...
<div class="device-center" style="margin-bottom: -20px;">
 ...
 if(0 == ($i%3)) { echo "device-center-3"; } else { echo "device-center-1"; } ?>
     ">
	 <h1><a href="<?php echo U('/armarium');?>/a/<?php echo ($vo["id"]); ?>.html" target="_blank"><?php echo ($vo["title"]); ?></a></h1>
	 <div><a href="<?php echo U('/armarium');?>/a/<?php echo ($vo["id"]); ?>.html" target="_blank"><img src="<?php echo (get_cover($vo["cover_id"],'path')); ?>" width="294" height="186"></a></div>
	 <p><?php echo (intro($vo["intro"],0,90)); ?><a href="<?php echo U('/armarium');?>/a/<?php echo ($vo["id"]); ?>.html" target="_blank">[详细]</a>
	</p>
	<a href="" class="iezxxq">咨询详情</a>
	<a href="<?php echo U('/armarium');?>/a/<?php echo ($vo["id"]); ?>.html" class="ieljsb">了解设备</a>
	 </div><?php endforeach; endif; else: echo "" ;endif; ?>
