...
<script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"0","bdSize":"16"},"share":{}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script></div>
            ...
            <div class="so_nr">
                ...
                <div class="dqdz">本文地址：<a href="http://www.th023.com<?php echo U('/armarium');?>/a/<?php echo ($Article_info["id"]); ?>.html">http://www.th023.com<?php echo U('/armarium');?>/a/<?php echo ($Article_info["id"]); ?>.html</a></div>
		  <!--文章内容下的按钮开始-->
		  <ul class="page-gu">
    ...
    <li> <a href="http://lvt.zoosnet.net/LR/Chatpre.aspx?id=LVT74007147&lng=cn" target="_blank"><img src="/Public/Home/i/4.jpg"></a></li>
		  ...
		  <!--文章内容下的按钮结束-->
                <div class="fy">
				    <?php if(($front != '')): ?><a href="<?php echo U('/armarium');?>/a/<?php echo ($front); ?>.html" class="fr">上一篇</a><?php endif; ?>
					<?php if(($after != '')): ?><a href="<?php echo U('/armarium');?>/a/<?php echo ($after); ?>.html" class="fl">下一篇</a><?php endif; ?>
                </div>
          </div>          
          <!--中间部分结束-->
        </div>
...
<div class="news-center-right">
	...
	<div data-am-widget="slider" class="am-slider am-slider-a1" data-am-slider='{"directionNav":false}' >
	  <ul class="am-slides">
		  <li>
			  <a href="<?php echo ($Category_info["a_side1_url"]); ?>" target="_blank"><img src="<?php echo (get_cover($Category_info["a_side1"],'path')); ?>" width="320" height="290"></a>
		  </li>
		  <li>
			  <a href="<?php echo ($Category_info["a_side2_url"]); ?>" target="_blank"><img src="<?php echo (get_cover($Category_info["a_side2"],'path')); ?>" width="320" height="290"></a>
		  </li><li>
			  <a href="<?php echo ($Category_info["a_side3_url"]); ?>" target="_blank"><img src="<?php echo (get_cover($Category_info["a_side3"],'path')); ?>" width="320" height="290"></a>
		  </li>
	  </ul>
	</div>
