...
<html class="no-js">
<head>
  <title>搜索 - <?php echo C('WEB_SITE_TITLE');?></title>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="description" content="泰恒眼科搜索">
  <meta name="keywords" content="泰恒眼科搜索">
...
<div class="news-quanju">
	<div class="news-center">
			<div class="news-center-left">
             <div class="page-news" style="height:150px; overflow:hidden;">
			 <p>当前位置：<?php echo C('WEB_SITE_TITLE');?> > 搜索 > <?php echo ($q); ?></p>
               <div style="text-align:center; width:605px; margin:30px 0;">
                 <form action="/s.html" method="get">
                   <input name="q" type="text" style="width:300px;" value="<?php echo ($q); ?>"> <input type="submit" value=" 搜索 ">
                 </form>
               </div>
			 </div>
      ...
      <?php if(is_array($Search_list)): $i = 0; $__LIST__ = $Search_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="list_lb">
        <div class="list_lb_1"><a href="
        <?php switch($vo["model_id"]): case "13": echo U('/illness');?>/a/<?php echo ($vo["id"]); ?>.html<?php break;?>
        <?php case "12": echo U('/video');?>/a/<?php echo ($vo["id"]); ?>.html<?php break;?>
        <?php case "11": echo U('/armarium');?>/a/<?php echo ($vo["id"]); ?>.html<?php break;?>
        <?php default: ?>
            <?php echo U('/news');?>/a/<?php echo ($vo["id"]); ?>.html<?php endswitch;?>
        " target="_blank"><b><?php echo ($vo["title"]); ?></b></a>
          <p class="rq">[<?php echo (date('Y-m-d',$vo["create_time"])); ?>]</p>
        </div>
        <div class="list_lb_2">　　<?php echo (intro($vo["description"],0,125)); ?><a href="<?php echo U('/illness');?>/a/<?php echo ($vo["id"]); ?>.html" target="_blank">[阅读全文]</a></div>
      </div><?php endforeach; endif; else: echo "" ;endif; ?>
      
      <?php if($Search_list == null): ?><div class="hig_30"></div>
      <div class="pages" style="text-align:center; margin:20px 0;">
          没有找到匹配内容
      </div><?php endif; ?>
   </div>
