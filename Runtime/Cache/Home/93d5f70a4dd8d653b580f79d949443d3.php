...
<div class="news-quanju">
	<div class="news-center">
			<div class="news-center-left">
             <div class="page-news">
			 <p>当前位置：<?php echo C('WEB_SITE_TITLE');?> > <?php echo ($Office_info["title"]); ?> > <?php echo ($Parent_info["title"]); ?> > <?php echo ($Category_info["title"]); ?></p>
             <?php if(($Category_info["wiki_c_banner_status"] == 1)): ?><div data-am-widget="list_news" class="am-list-news am-list-news-default am-no-layout" style="
"><img src="<?php echo (get_cover($Category_info["wiki_c_banner"],'path')); ?>" width="605" height="158"></div>
             <?php else: ?>
...
">
		   ...
		   <ul class="am-list">
            <?php if(is_array($recommends)): $i = 0; $__LIST__ = array_slice($recommends,0,4,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rvo1): $mod = ($i % 2 );++$i;?><li class="am-g am-list-item-dated">
				  <a href="<?php echo U('/illness');?>/a/<?php echo ($rvo1["id"]); ?>.html" target="_blank" class="am-list-item-hd "><?php echo ($rvo1["title"]); ?></a>
				  <span class="am-list-date"><a href="<?php echo U('/illness');?>/a/<?php echo ($rvo1["id"]); ?>.html" target="_parent">[<?php echo (date('m-d',$rvo1["create_time"])); ?>]</a></span>
...
">
		   ...
		   <ul class="am-list">
            ...
            <?php if(is_array($recommends)): $i = 0; $__LIST__ = array_slice($recommends,4,4,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rvo1): $mod = ($i % 2 );++$i;?><li class="am-g am-list-item-dated">
				  <a href="<?php echo U('/illness');?>/a/<?php echo ($rvo1["id"]); ?>.html" target="_blank" class="am-list-item-hd "><?php echo ($rvo1["title"]); ?></a>
				  <span class="am-list-date"><a href="<?php echo U('/illness');?>/a/<?php echo ($rvo1["id"]); ?>.html" target="_blank">[<?php echo (date('m-d',$rvo1["create_time"])); ?>]</a></span>
			</li><?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <li> <a href="http://lvt.zoosnet.net/LR/Chatpre.aspx?id=LVT74007147&lng=cn" target="_blank"><img src="/Public/Home/i/4.jpg"></a></li>
			 ...
			 <div class="wzlb">
      <div class="wzlb_1"><img src="/Public/Home/i/news/xinwen.png" class="wzimg fl">
        <p><?php echo ($Category_info["title"]); ?></p>
      </div>
      
      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="list_lb">
        <div class="list_lb_1"><a href="<?php echo U('/illness');?>/a/<?php echo ($vo["id"]); ?>.html" target="_blank"><b><?php echo ($vo["title"]); ?></b></a>
          <p class="rq">[<?php echo (date('Y-m-d',$vo["create_time"])); ?>]</p>
        </div>
        <div class="list_lb_2">　　<?php echo (intro($vo["content"],0,125)); ?><a href="<?php echo U('/illness');?>/a/<?php echo ($vo["id"]); ?>.html" target="_blank">[阅读全文]</a></div>
        <div class="lb_tag"><span class="lb_tag_1">TAG：</span><a href="<?php echo U('/illness');?>/a/<?php echo ($vo["id"]); ?>.html" target="_blank" class="lb_tag_2"><?php echo ($vo["tag"]); ?></a> <a href="http://lvt.zoosnet.net/LR/Chatpre.aspx?id=LVT74007147&lng=cn" target="_blank" class="lb_zx">点击咨询</a></div>
      </div><?php endforeach; endif; else: echo "" ;endif; ?>
