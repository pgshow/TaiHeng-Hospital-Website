...
<div class="news-quanju">
	<div class="news-center">
			...
			<div class="illness">
			<h2><?php echo ($Category_info["title"]); ?><span><?php echo ($Category_info["eng_title1"]); ?></span></h2>
				<div class="hos-1 illness-1">
					<div class="left-list"> <a href="<?php echo U('/illness');?>/i/<?php echo ($topic_info["id"]); ?>.html" title="<?php echo ($topic_info["title"]); ?>" target="_blank"><img src="<?php echo (get_cover($topic_info["banner"],'path')); ?>" width="296" height="128"></a>
					   <p><span class="intro">项目简介：</span><?php echo (intro($topic_info["content1"],0,80)); ?>[<a href="<?php echo U('/illness');?>/i/<?php echo ($topic_info["id"]); ?>.html" target="_blank">详细</a>]</p>
			      </div>
		      </div>
  ...
  <?php if(is_array($article_list)): $i = 0; $__LIST__ = $article_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$avo): $mod = ($i % 2 );++$i;?><li class="am-g am-list-item-dated">
          <a href="<?php echo U('/illness');?>/a/<?php echo ($avo["id"]); ?>.html" target="_blank" class="am-list-item-hd "><?php echo ($avo["title"]); ?></a>
          <span class="am-list-date"><a href="<?php echo U('/illness');?>/a/<?php echo ($avo["id"]); ?>.html" target="_blank">[<?php echo (date('m-d',$avo["create_time"])); ?>]</a></span>
    </li><?php endforeach; endif; else: echo "" ;endif; ?>
    
  </ul>
	<div style="text-align:center;">
	<a href="/armarium/" target="_blank"><img src="/Public/Home/i/tabs/2.jpg"></a>
	<a href="http://lvt.zoosnet.net/LR/Chatpre.aspx?id=LVT74007147&lng=cn" target="_blank"><img src="/Public/Home/i/tabs/3.jpg"></a>
	</div>
    </div>
...
<div class="guanggao">
        <!--大图轮播开始-->
        <style type="text/css">
		#container { width: 647px; height: 97px; border: 0px solid #333; overflow: hidden; position: relative;}
        #list { width: 4326px; height: 97px; position: absolute; z-index: 1;}
        #list img { float: left;}
        ...
        <div id="container">
          <div id="list"><a href="<?php echo ($Office_info["illness_banner_url"]); ?>" target="_blank"><img src="<?php echo (get_cover($Office_info["illness_banner"],'path')); ?>" width="648" height="98"></a></div>
        </div>
...
<!--广告结束-->			
		<div class="ill-top">
          ...
          <?php
 if(0 == (($key+1)%2)) { echo "ill-top-2"; } else { echo "ill-top-1"; } ?>
          ">
			<h1><a href="\<?php echo ($Office_info["name"]); ?>\<?php echo ($clvo1["name"]); ?>\"><?php echo ($clvo1["title"]); ?></a></h1>
			<div>
			<a href="<?php echo U('/illness');?>/a/<?php echo ($clvo1["articles"]["0"]["id"]); ?>.html" target="_blank"><span class="top_article"><?php echo ($clvo1["articles"]["0"]["title"]); ?></span></a>
			<p>
			
			<?php echo (intro($clvo1["articles"]["0"]["content"],0,80)); ?>[<a href="<?php echo U('/illness');?>/a/<?php echo ($clvo1["articles"]["0"]["id"]); ?>.html" target="_blank">详细</a>]
			</p>
			</div>
			<div class="off-1"><a href="\<?php echo ($Office_info["name"]); ?>\<?php echo ($clvo1["name"]); ?>\" target="_blank"><img src="<?php echo (get_cover($clvo1["icon"],'path')); ?>" width="290" height="127"></a>
		    <div data-am-widget="list_news" class="am-list-news am-list-news-default am-no-layout">
			 <div class="am-list-news-bd">
		   <ul class="am-list">
            <?php if(is_array($clvo1["articles"])): $i = 0; $__LIST__ = array_slice($clvo1["articles"],1,5,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$clvo2): $mod = ($i % 2 );++$i;?><li class="am-g am-list-item-dated">
        ...
        <div class="left-zm">
          <div data-am-widget="slider" class="am-slider am-slider-d1 am-no-layout" data-am-slider="{&quot;controlNav&quot;:false}">
            ...
            <ul class="am-slides" style="width: 1200%; transition-duration: 0.6s; transform: translate3d(-606px, 0px, 0px);">
              <li class="clone" aria-hidden="true" style="width: 303px; float: left; display: block;"> <a href="<?php echo U('/specialist');?>/a/<?php echo ($specialist["id"]); ?>.html" target="_blank"><img src="<?php echo (get_cover($specialist["photo"],'path')); ?>" width="278" height="208" draggable="false"></a>
                  <div class="am-slider-desc">
                    <div class="mingren">
                    <h2 class="am-slider-title"><?php echo ($specialist["title"]); ?><br><span><?php echo ($specialist["situation"]); ?></span></h2>
                    </div>
                    <div class="mingyuyue">
                    <a href="<?php echo U('/specialist');?>/a/<?php echo ($specialist["id"]); ?>.html" target="_blank" class="m1">点击详细</a><a href="http://lvt.zoosnet.net/LR/Chatpre.aspx?id=LVT74007147&lng=cn" target="_blank" class="m2">立即预约</a>
                    </div>
                  </div>
              </li>
