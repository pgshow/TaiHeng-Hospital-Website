...
<div class="news-quanju">
	<div class="news-center">
			<div class="news-center-left">
			 <img src="<?php echo (get_cover($Category_info["news_banner"],'path')); ?>" style="
    width: 100%;
">
			 <div class="wzlb">
      ...
      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="list_lb">
        <div class="list_lb_1"><a href="<?php echo U('/news');?>/a/<?php echo ($vo["id"]); ?>.html" target="_blank"><b><?php echo ($vo["title"]); ?></b></a>
          <p class="rq">[<?php echo (date('Y-m-d',$vo["create_time"])); ?>]</p>
        </div>
        <div class="list_lb_2">　　<?php echo (intro($vo["content"],0,145)); ?><a href="<?php echo U('/news');?>/a/<?php echo ($vo["id"]); ?>.html" target="_blank">[阅读全文]</a></div>
        <div class="lb_tag">
        <span class="lb_tag_1">TAG：</span><a href="<?php echo U('/news');?>/a/<?php echo ($vo["id"]); ?>.html" class="lb_tag_2"><?php echo ($vo["tag"]); ?></a> 
        <a href="http://lvt.zoosnet.net/LR/Chatpre.aspx?id=LVT74007147&lng=cn" target="_blank" class="lb_zx">点击咨询</a></div>
      </div><?php endforeach; endif; else: echo "" ;endif; ?>
